...
class Cube:
    ...
    def __init__(self, N=3, plastic_color=None, face_colors=None, cube_faces=None):
        self.N = N
        ...
        self._move_list = []
        self._initialize_arrays(cube_faces)

    def _initialize_arrays(self, cube_faces):
